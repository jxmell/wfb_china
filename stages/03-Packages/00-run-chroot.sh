...
sudo echo "deb https://mirrors.ustc.edu.cn/raspbian/raspbian/ stretch main contrib non-free rpi">>./etc/apt/sources.list
sudo echo "deb https://mirrors.tuna.tsinghua.edu.cn/raspbian/raspbian/ stretch main contrib non-free rpi">>./etc/apt/sources.list
sudo echo "deb-src https://mirrors.tuna.tsinghua.edu.cn/raspbian/raspbian/ stretch main contrib non-free rpi">>./etc/apt/sources.list
sudo echo "deb https://mirrors.ustc.edu.cn/archive.raspberrypi.org/debian/ stretch main ui">>./etc/apt/sources.list.d/raspi.list
sudo echo "deb https://mirror.tuna.tsinghua.edu.cn/raspberrypi/ stretch main ui">>./etc/apt/sources.list.d/raspi.list
sudo echo "deb-src https://mirror.tuna.tsinghua.edu.cn/raspberrypi/ stretch main ui">>./etc/apt/sources.list.d/raspi.list
